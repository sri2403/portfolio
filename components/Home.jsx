        ...
        <section id="home" className="container-fluid d-flex flex-column justify-content-center align-items-center" style={{ minHeight: '90vh', padding: '20px' }}>
            <div className="text-center">
                ...
                <div className="mb-4">
                    ...
                    <a href='https://drive.google.com/file/d/1fui_frs19CQfBjGCQj3sNGpBI2vvimPG/view' target='_blank' rel='noopener noreferrer' className="btn btn-outline-primary"><i className="fas fa-file"></i> Resume</a>
                </div>
            </div>
        </section>
    );
